 ...
 * @author jpp
 */
public class Gravitation02_ClassicWindowed extends javax.swing.JFrame {
    /**
     * Creates new form ApplicationGravitation
     */
    
    public Gravitation02_ClassicWindowed() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gravitation02_ClassicWindowed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gravitation02_ClassicWindowed().setVisible(true);
            }
        });
    }
